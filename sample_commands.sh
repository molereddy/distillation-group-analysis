...
#dedier
TZ=America/New_York date; python3 run_exp.py --method dedier -s confounder -d CUB -t waterbird_complete95 -c forest2water2 --model_type resnet18-pt --teacher_type resnet50-pt_group_DRO --batch_size 64 --alpha 6 --beta 3 --n_epochs 20; TZ=America/New_York date; 
