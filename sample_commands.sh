...
#dedier
TZ=IST-5:30 date; python3 run_exp.py --method dedier -s confounder -d CUB -t waterbird_complete95 -c forest2water2 --model resnet18-pt --teacher resnet50-pt_group_DRO --batch_size 64 --alpha 6 --beta 3 --n_epochs 20; TZ=IST-5:30 date; 
